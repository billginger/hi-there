...
const Hobbies = () => {
  return (
    <div id="Hobbies" className="bg-hobbies">
      <div className="container mx-auto px-3 pt-8 pb-4">
        <div className="text-center p-2">
          <h2 className="inline text-3xl font-semibold text-gray-800 dark:text-white border-b-2 border-blue-300">
            Hobbies
          </h2>
        </div>
        <div className="flex pt-6 text-gray-900 dark:text-white flex-col md:flex-row">
          ...
          <div className="flex-1 pb-6 md:mx-6">
