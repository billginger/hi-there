...
const Intro = () => {
  return (
    <div id="Intro" className="relative pt-[60px] overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-[#f9ffff] to-white dark:from-gray-700 dark:to-gray-900">
        <div
          className="absolute w-40 h-40 rounded-full left-1/4 bottom-8 bg-gradient-to-b from-indigo-50 to-transparent
            dark:from-slate-700 hidden lg:block"
        />
        <div
          className="absolute w-60 h-60 rounded-full right-1/4 -top-10 bg-gradient-to-t from-indigo-50 to-transparent
            dark:from-slate-700"
        />
        <div
          className="absolute w-[500px] h-[500px] rounded-full right-[5%] -bottom-[240px] bg-gradient-to-b
            from-indigo-50 via-transparent to-transparent dark:from-slate-700 dark:via-transparent"
        />
      </div>
